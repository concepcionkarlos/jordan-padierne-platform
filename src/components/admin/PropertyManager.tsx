    ...
    <div>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div ref={editModalRef} role="dialog" aria-modal="true" aria-label={editId ? 'Edit property' : 'Add property'} tabIndex={-1} className="relative bg-white rounded-2xl shadow-premium w-full max-w-2xl max-h-[90vh] overflow-y-auto scrollbar-thin">
      ...
      {aiOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div ref={aiModalRef} role="dialog" aria-modal="true" aria-label="Quick-add a property with AI" tabIndex={-1} className="relative bg-white rounded-2xl shadow-premium w-full max-w-lg overflow-hidden">
