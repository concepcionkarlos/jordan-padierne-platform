  ...
  if (submitted) {
    return (
      <div className="text-center py-10">
        ...
        <h3 className="font-serif text-xl font-bold text-navy-900 mb-2">{t('forms.buyer.successTitle')}</h3>
        <p className="text-gray-500 text-sm">{t('forms.buyer.successSub')}</p>
      </div>
    )
  }
